...
public class Game implements Parcelable{
    ...
    // Parcelable interface uses a private constructor to instatiate objects
    ...
    public static final Parcelable.Creator<Game> CREATOR = new Parcelable.Creator<Game>() {
        /**
         * This method is used with Intents to crate new Game objects.
         *
         * @param parcel The package with all the information for the Game
         * @return tThe new Game object
         */
        @Override
         ...
         * @param size Of the JSON array (How many games).
